...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_stack.release.cpp, i8* null }]
...
define internal void @_GLOBAL__sub_I_stack.release.cpp() section ".text.startup" {
