...
@.str = private unnamed_addr constant [14 x i8] c"DEBUG: << %d\\0A\\00", align 1
@.str2 = private unnamed_addr constant [24 x i8] c"DEBUG: Stack Size = %d\\0A\\00", align 1
...
define void @__push(i32 %x) #0 {
  ...
  %4 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i32 %3)
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* @_ZL5stack, i32* %1)
  %5 = load %struct._IO_FILE** @stderr, align 8
  %6 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @_ZL5stack) #2
  %7 = trunc i64 %6 to i32
  %8 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([24 x i8]* @.str2, i32 0, i32 0), i32 %7)
  ret void
}
...
define i32 @__pop() #0 {
  ...
  %6 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0), i32 %5)
  call void @_ZNSt6vectorIiSaIiEE8pop_backEv(%"class.std::vector"* @_ZL5stack)
  %7 = load %struct._IO_FILE** @stderr, align 8
  %8 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @_ZL5stack) #2
  %9 = trunc i64 %8 to i32
  %10 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([24 x i8]* @.str4, i32 0, i32 0), i32 %9)
...
define i32 @__peek() #0 {
  ...
  %4 = load %struct._IO_FILE** @stderr, align 8
  %5 = load i32* %x, align 4
  %6 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([14 x i8]* @.str5, i32 0, i32 0), i32 %5)
...
define internal void @_GLOBAL__sub_I_debug.cpp() section ".text.startup" {
